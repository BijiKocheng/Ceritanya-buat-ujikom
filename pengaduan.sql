...
CREATE TABLE `masyarakat` (
  ...
  `status` enum('tidak','aktif') NOT NULL
...
('1819001', 'irfan setiawan', 'irfan', '$2y$10$OYnVq1N/HkJJfZJlHXxt0uZgR/9qTIKC64R.DEct2NKLYEuQM4Mj2', '234234234', 'aktif');
...
(17, 'Ceritanya admin', 'admin', 'admin', '082112141098', 'admin');
